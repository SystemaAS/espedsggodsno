				...
				<table id="containerdatatableTable" style="width:60%" cellspacing="1" border="0" align="left">
						...
						<table id="mainList" class="display compact cell-border" >
				            ...
				            <c:forEach var="record" items="${model.list}" varStatus="counter">   
				               ...
				               <td align="center" width="2%" id="recordUpdate_${record.gflavd}_${record.gflbko}" class="tableCellFirst" onClick="getRecord(this);" style="cursor:pointer; border-style: solid;border-width: 0px 1px 1px 0px;border-color:#FAEBD7;" >
