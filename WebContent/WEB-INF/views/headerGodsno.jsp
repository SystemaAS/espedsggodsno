...
<html>
	<head>
		...
		<title>eSpedsg - Godsregistrering</title>
	    			 ...
	    			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
					 	...
					 	<tr>
					 		...
					 		<td class="text32Bold" width="100%" align="middle" valign="middle" style="color:#778899;" >
					 			eSped<font style="color:#003300;">sg</font> - <spring:message code="systema.godsno.title"/>
    			 ...
    			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				 	<tr >
			    		<td class="text14" width="70%" align="left" >&nbsp;&nbsp;
			    			...
			    			<%-- Maintenance  MENU    --%>
			    			<%-- -------------------- --%>
			    			<a id="alinkMaintGate" tabindex=-1 href="godsnomaintenance.do">
	      				...
	      				<td class="text14" width="50%" align="right" valign="middle">
		      				...
		      				<font class="headerMenuGreen">
		    				    ...
		    				    <div class="text11" style="position: relative; display:inline;" align="left">
									<span style="position:absolute; left:-200px; top:5px;" id="versionInfo" class="popupWithInputText"  >	
